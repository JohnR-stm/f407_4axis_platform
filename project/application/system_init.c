...
#include "stm32f4xx_ll_system.h" // FLASH
...
{
  //--- flash latency ---//
  LL_FLASH_SetLatency(LL_FLASH_LATENCY_1); // LL_FLASH_LATENCY_4
  ...
  //--- PLL ---//
  LL_RCC_PLL_ConfigDomain_SYS(LL_RCC_PLLSOURCE_HSE, LL_RCC_PLLM_DIV_4, 50, LL_RCC_PLLP_DIV_2);
  LL_RCC_PLL_Enable();
